%demo5_isovalues_2d.m Plots isolines of 2D simulation results
%
...
toc;
%Consider changing fftri2grid() into fftri2gridfast() which is approx.
%x33 (Octave) x15 (Matlab) faster (MEX implementation)
