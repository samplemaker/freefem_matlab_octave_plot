...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'SGridParam',[30,30], ...
            'Boundary','off','ColorMap',jet(200),'ColorBar','on','BoundingBox','on');

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'BDLabels',[30,31],'ColorMap','jet');

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'BDLabels',[30,31], ...
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'BDLabels',[40,42,43,55], ...
            'XYZStyle','noface','ColorMap','jet');

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'FlowData',[Ex,Ey,Ez],'FGridParam3D',[10,10,5],'BDLabels',[30,31],'XYZStyle','monochrome');

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'FlowData',[Ex,Ey,Ez],'FGridParam3D',[8,8,5],'FLim3D',[0.125,0.625;0.125,0.625;0.1,0.4],'BDLabels',[30,31],'XYZStyle','monochrome');

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'FlowData',[Ex,Ey,Ez],'Slice',S1,S2,S3,'BDLabels',[30,31], ...
            'XYZStyle','noface','ColorMap','jet');
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'FlowData',[Ex,Ey,Ez],'Slice',S1,S2,S3,'Boundary','off', ...
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'FlowData',[Ex,Ey,Ez],'Slice',S1,S2,S3, ...
            'BDLabels',[30,31],'XYZStyle','noface','ColorMap','jet','BoundingBox','on');

%plot all boundaries and color the plot
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'ColorMap','jet');
%axis off;

figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'ColorMap','jet', ...
            'ColorRange','centered','ColorBar','on','ColorBar','northoutside');
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'ColorMap','jet','BDLabels',[30,31]);
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'SGridParam',[300,300],'BDLabels',[30,31], ...
            'XYZStyle','monochrome', ...
...
figure;
ffpdeplot3D(p,b,t,'VhSeq',vh,'XYZData',u,'Slice',S1,S2,S3,'SGridParam',[300,300], ...
